// Login page with email/password fields and social login buttons
...
export default function Login() {
    ...
    // Handler registration buttons to initiate registration
    const register = async (e) => {
        e.preventDefault() // stop page refresh
        await handleRegistration(email, password)
    }

    // Handler login buttons to initiate login
    const login = async (e) => {
        e.preventDefault() // stop page refresh
